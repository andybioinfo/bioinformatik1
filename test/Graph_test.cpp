...
TEST(GraphBuilder, emptyListToGraph)
{
    auto emptySeqList = SequenceCombinator(0, 0, true);
    auto NotemptySeqList = SequenceCombinator(0, 0, false);
...
TEST(GraphBuilder, AddMultiEdges)
{
    // Create Graph:
    SeqList SeqTriplePack = SequenceCombinator(0, 3, false);
    Graph<Sequence<Alphabet::DNA>> g(SeqTriplePack);
...
TEST(GraphBuilder, GraphOnlyNodes)
{
...
TEST(GraphBuilder, contractEdgeTest)
{
...
TEST(GraphBuilder, removeEdgeTest)
{
    // Create Graph:
    SeqList SeqTriplePack = SequenceCombinator(0, 3, false);
    Graph<Sequence<Alphabet::DNA>> g(SeqTriplePack);
