 ...
 * */
template <typename NodeLabel>
typename Graph<NodeLabel>::Node *Graph<NodeLabel>::contractEdge(const Graph<NodeLabel>::Edge &rem)
{
 ...
 */
template <typename NodeLabel>
typename Graph<NodeLabel>::node_iterator Graph<NodeLabel>::beginNodes() { return nodes_.begin(); }
/** returns a constant of the node-iterator
 */
template <typename NodeLabel>
typename Graph<NodeLabel>::node_iterator Graph<NodeLabel>::endNodes() { return nodes_.end(); }
/** returns a constant of the node-iterator
 */
template <typename NodeLabel>
typename Graph<NodeLabel>::const_node_iterator Graph<NodeLabel>::beginNodes() const { return nodes_.begin(); }
/** returns a constant of the node-iterator
 */
template <typename NodeLabel>
typename Graph<NodeLabel>::const_node_iterator Graph<NodeLabel>::endNodes() const { return nodes_.end(); }
 ...
 * */
template <typename NodeLabel>
size_t Graph<NodeLabel>::numNodes() const { return nodes_.size(); }
